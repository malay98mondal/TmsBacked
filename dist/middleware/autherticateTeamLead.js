...
exports.authenticateTeamLead = void 0;
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config();
const secret = "team_lead_jwt_secret";
const authenticateTeamLead = (req, res, next) => {
...
exports.authenticateTeamLead = authenticateTeamLead;
